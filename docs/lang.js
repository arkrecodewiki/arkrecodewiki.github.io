const i18n = {
  en: {
    ...
    info: {
      ...
      sez_encroach: 'Shatter Attack',
      silk_automatic_fire: 'Multi Turbine Arrows',
      s1_extra_attack: 'S1 Extra Attack',
      s1_soulburn: 'S1 Astrogen Burst',
      s2_wave_2: 'S2 Follow Up',
  ...
  jp: {
    heroes: {
      ...
      holy_flame_adin: '聖炎のアーディン',
      hurado: 'ヒュラド',
      hwayoung: 'フィナス',
      ian: 'イアン',
      ilynav: 'イリーナブ', 
      inferno_khawazu: '狂炎のカワズ',
      infinite_horizon_achates: '未知の可能性 アカテス',
      iseria: 'イセリア',
      jack_o: 'ジャック・オー',
      januta: 'ジャスタ',
      jecht: 'ジェクト',
      ...
      montmorancy: 'モンモランシー',
      moon_bunny_dominiel: '月うさぎ ドミニエル',
      mort: 'モルト',
      mucacha: 'ムカチャ',
      mui: 'ミュイ',
      muse_rima: 'ミューズ リマ',
      ...
      rimuru: 'リムル',
      rin: 'リン',
      riza_hawkeye: 'リザ・ホークアイ',
      roaming_warrior_leo: '放浪勇者 レオ',
      roana: 'ロエンナ',
      romann: 'ローマン',
      roozid: 'ルージット',
      rose: 'ロゼ',
      roy_mustang: 'ロイ・マスタング',
      ruele_of_light: '神光のルエル',
      sage_baal_and_sezan: '賢者 バアル＆セザン',
      savior_adin: '救済者 アーディン',
      schuri: 'シュリ',
      senya: 'シェナ',
      shadow_knight_pyllis: '黒騎士ピィリス',
      shepherd_jena: '導き手 ジェナ',
      shooting_star_achates: '流れ星☆アカテス',
      shuna: 'シュナ',
      seaside_bellona: '海辺のヴェローナ',
      serene_purity_adin: '清冽のアーディン',
      serila: 'セリラ',
      sez: 'セズ',
      shadow_rose: '暗躍のロゼ',
      sharun: 'シャルン',
      ...
      straze: 'ストラゼス',
      summer_break_charlotte: '夏休みのシャルロッテ',
      summer_disciple_alexa: '夏の弟子 アレクサ',
      summertime_iseria: '南国のイセリア',
      surin: 'スーリン',
      sven: 'スヴェン',
      sylvan_sage_vivian: '森の賢者 ヴィヴィアン',
      taeyou: 'ティル',
      tamarinne: 'ルリ',
      talaz: 'タラズ',
      talia: 'タリア',
      ...
      twisted_eidolon_kayron: '歪みし亡霊 カイロン',
      tywin: 'タイウィン',
    ...
    artifacts: {
      ...
      an_offer_you_cant_refuse: '断れない提案',
      ambrote: 'アンブローテ',
      ancient_sheath: '古の剣鞘',
      ...
      scroll_of_shadows: '影の書',
      severed_horn_wand: '折られし角の杖',
      shepherd_of_the_hollow: '無為なる導者',
      sigurd_scythe: 'シグルの大鎌',
      spear_of_a_new_dawn: '始まりの槍',
      spear_of_purification: '破邪の矛',
      star_of_the_deep_sea: '闇海に瞬く星',
      sword_of_cycling_seasons: '循環の剣',
  ...
  zhTW: {
    heroes: {
      ...
      command_model_laika: '指揮型萊伊卡',
      commander_pavel: '司令官帕貝爾',
      ...
      holy_flame_adin: '聖炎的艾庭',
      hurado: '修拉杜',
      hwayoung: '和英',
      ian: '伊安',
      ilynav: '伊莉娜芙',
      inferno_khawazu: '烈焰的卡瓦朱',
      infinite_horizon_achates: '未知的可能性雅卡泰絲',
      iseria: '伊賽麗亞',
      jack_o: '潔克‧歐',
      januta: '扎努塔',
      jecht: '傑克托',
      ...
      straze: '史瑞杰思',
      summer_break_charlotte: '暑假夏綠蒂',
      summer_disciple_alexa: '夏天的學生雅莉莎',
      summertime_iseria: '南國的伊賽麗亞',
      surin: '蘇琳',
      sven: '史賓',
      sylvan_sage_vivian: '森之賢者薇薇安',
      taeyou: '太悟',
      tamarinne: '塔瑪林爾',
      talaz: '達拉士',
      talia: '達黎兒',
      ...
      twisted_eidolon_kayron: '扭曲的亡靈凱隆',
      tywin: '泰溫',
    ...
    artifacts: {
      ...
      an_offer_you_cant_refuse: '無法拒絕的提議',
      ...
      frame_of_light: '光之框架',
      hell_cutter: '地獄切割機',
      hostess_of_the_banquet: '宴會之主',
      ignition_cloth_gloves: '發火布手套',
      iron_fan: '鐵扇',
      jack_o_symbol: '潔克‧歐的象徵',
      junkyard_dog: 'Junkyard Dog', // No translation in-game
      kaladra: '嘉拉特拉',
      last_teatime: '最後的下午茶',
  ...
  zhCN: {
    heroes: {
      ...
      ilynav: '伊莉娜芙',
      inferno_khawazu: '烈焰的卡瓦朱',
      infinite_horizon_achates: '未知的可能性雅卡泰絲', // TODO: Simplified when available
      iseria: '伊赛丽亚',
      jack_o: '杰克·欧',
      januta: '扎努塔',
      jecht: '杰克托',
    ...
    artifacts: {
      ...
      hell_cutter: '地狱切割机',
      hostess_of_the_banquet: '宴會之主', //TODO: Simplified when available
      ...
      star_of_the_deep_sea: '深海漂浮之星',
      sword_of_cycling_seasons: '循環之劍', // TODO: update to simplified when possible
  ...
  kr: {
    heroes: {
      ...
      command_model_laika: '지휘형 라이카',
      commander_pavel: '지휘관 파벨',
      ...
      holy_flame_adin: '성염의 아딘',
      hurado: '휴라두',
      hwayoung: '화영',
      ian: '이안',
      ilynav: '일리나브',
      inferno_khawazu: '광염의 카와주',
      infinite_horizon_achates: '미지의 가능성 아카테스',
      iseria: '이세리아',
      jack_o: '잭 오',
      januta: '자누타',
      jecht: '제크토',
      ...
      senya: '셰나',
      shadow_knight_pyllis: '흑기사 필리스',
      serene_purity_adin: '청현의 아딘',
      serila: '세릴라',
      sez: '세즈',
      shadow_rose: '그림자 로제',
      sharun: '샤룬',
      shepherd_jena: '인도자 제나',
      ...
      straze: '스트라제스',
      summer_break_charlotte: '여름 방학 샬롯',
      summer_disciple_alexa: '여름의 제자 알렉사',
      summertime_iseria: '남국의 이세리아',
      surin: '수린',
      sven: '스벤',
      sylvan_sage_vivian: '숲의 현자 비비안',
      taeyou: '태유',
      tamarinne: '타마린느',
      talaz: '탈라즈',
      talia: '탈리아',
      ...
      twisted_eidolon_kayron: '뒤틀린 망령 카일론',
      tywin: '타이윈',
    ...
    artifacts: {
      ...
      an_offer_you_cant_refuse: '거절할 수 없는 제안',
      ...
      hell_cutter: '지옥 절단기',
      hostess_of_the_banquet: '연회의 주인',
      ignition_cloth_gloves: '발화포 장갑',
      iron_fan: '철선',
      jack_o_symbol: '잭 오의 상징',
      junkyard_dog: '정크야드 도그',
      kaladra: '칼라드라',
  ...
  pt: {
    heroes: {
      ...
      angelica: 'Angélica',
      apocalypse_ravi: 'Ravi Apocalíptica',
      aramintha: 'Araminta',
      arbiter_vildred: 'Árbitro Vildred',
      archdemon_shadow: 'Sombra do Arquidemônio',
      architect_laika: 'Planejadora Laika',
      aria: 'Aria',
      armin: 'Armina',
      arowell: 'Arowell',
      arunka: 'Arunka',
      assassin_cartuja: 'Assassino Cartuja',
      assassin_cidd: 'Assassino Cidd',
      assassin_coli: 'Assassina Coli',
      astromancer_elena: 'Elena Oráculo Estelar',
      auxiliary_lots: 'Ajudante Lots',
      azalea: 'Azaleia',
      baal_and_sezan: 'Baal e Sezan',
      bad_cat_armin: 'Armina Gatinha Malvada',
      baiken: 'Baiken',
      basar: 'Bassar',
      bask: 'Bask',
      batisse: 'Batisse',
      ...
      cecilia: 'Cecília',
      celeste: 'Celeste',
      celestial_mercedes: 'Mercedes Celestial',
      celine: 'Celine',
      cerise: 'Cerise',
      cermia: 'Cérmia',
      challenger_dominiel: 'Desafiante Dominiel',
      champion_zerato: 'Campeão Zerato',
      chaos_inquisitor: 'Inquisidor do Caos',
      chaos_sect_axe: 'Machadeiro da Seita do Caos',
      charles: 'Charles',
      charlotte: 'Charlotte',
      chloe: 'Chloe',
      choux: 'Choux',
      christy: 'Christie',
      church_of_ilryos_axe: 'Machadeiro de Ilírio',
      cidd: 'Cidd',
      clarissa: 'Clarissa',
      closer_charles: 'Exterminador Charles',
      coli: 'Coli',
      commander_lorina: 'Comandante Lorina',
      command_model_laika: 'Modelo Comandante Laika',
      commander_pavel: 'Comandante Pavel',
      conqueror_lilias: 'Lilias Soberana',
      corvus: 'Corvus',
      crescent_moon_rin: 'Rin da Lua Crescente',
      crimson_armin: 'Armina Carmesim',
      crozet: 'Crozet',
      dark_corvus: 'Corvus das Trevas',
      death_dealer_ray: 'Ray Investigador da Morte',
      ...
      dingo: 'Dingo',
      dizzy: 'Dizzy',
      doll_maker_pearlhorizon: 'Horizompérola Bonequeira',
      dominiel: 'Dominiel',
      doris: 'Dóris',
      eaton: 'Eaton',
      eda: 'Eda',
      ...
      fallen_cecilia: 'Cecília Caída',
      fighter_maya: 'Lutadora Maya',
      flan: 'Flan',
      free_spirit_tieria: 'Tiéria Espírito Livre',
      furious: 'Fúrio',
      general_purrgis: 'General Felinus',
      glenn: 'Glenn',
      gloomyrain: 'Lacrimosa',
      godmother: 'Madrinha',
      great_chief_khawana: 'Honorável Chefe Khawana',
      guider_aither: 'Guia Aither',
      gunther: 'Gunther',
      hataan: 'Hatan',
      hasol: 'Hasol',
      haste: 'Presto',
      ...
      helen: 'Helen',
      helga: 'Helga',
      holiday_yufine: 'Yufina Veranil',
      holy_flame_adin: 'Adine Chama Sagrada',
      hurado: 'Hurado',
      hwayoung: 'Hwa Young',
      ian: 'Ian',
      ilynav: 'Ilynav',
      ...
      khawana: 'Khawana',
      khawazu: 'Khawazu',
      kikirat_v2: 'Kikirato v2',
      kiris: 'Kiris',
      kise: 'Kise',
      kitty_clarissa: 'Clarissa Gatinha',
      kizuna_ai: 'Kizuna AI',
      kluri: 'Kluri',
      krau: 'Krato',
      landy: 'Landy',
      ...
      lone_crescent_bellona: 'Bellona Lua Solitária',
      lorina: 'Lorina',
      lots: 'Lots',
      lua: 'Lua',
      lucy: 'Lucy',
      ...
      luluca: 'Luluca',
      luna: 'Luna',
      magic_scholar_doris: 'Estudiosa de Magia Dóris',
      maid_chloe: 'Criada Chloe',
      martial_artist_ken: 'Artista Marcial Ken',
      mascot_hazel: 'Castânia Mascote',
      maya: 'Maya',
      mediator_kawerik: 'Kawerik Mediador',
      melany: 'Melanie',
      melissa: 'Melissa',
      mercedes: 'Mercedes',
      ...
      mirsa: 'Mirsa',
      mistychain: 'Nebuleia',
      moon_bunny_dominiel: 'Dominiel Coelhinha Lunar',
      ...
      otillie: 'Otília',
      pavel: 'Pavel',
      peacemaker_furious: 'Fúrio Conciliador',
      pearlhorizon: 'Horizompérola',
      peira: 'Feyra',
      penelope: 'Penélope',
      pirate_captain_flan: 'Flan Capitã Pirata',
      politis: 'Politis',
      purrgis: 'Felinus',
      pyllis: 'Fílis',
      ras: 'Ras',
      ...
      rimuru: 'Rimuru',
      rin: 'Rin',
      riza_hawkeye: 'Riza Hawkeye',
      roaming_warrior_leo: 'Guerreiro Nômade Léo',
      roana: 'Roena',
      romann: 'Romann',
      roozid: 'Ruzide',
      rose: 'Rosa',
      roy_mustang: 'Roy Mustang',
      ruele_of_light: 'Ruele da Luz',
      sage_baal_and_sezan: 'Sábio Baal e Sezan',
      savior_adin: 'Adine Salvadora',
      schuri: 'Schuri',
      seaside_bellona: 'Bellona Praieira',
      senya: 'Senya',
      shadow_knight_pyllis: 'Fílis Cavaleira da Sombra',
      serene_purity_adin: 'Adine Cristal Puro',
      serila: 'Serila',
      sez: 'Sez',
      shadow_rose: 'Rosa Sombria',
      sharun: 'Sharun',
      shooting_star_achates: 'Estrela Cadente Acates',
      shuna: 'Shuna',
      shepherd_jena: 'Pastora Jena',
      sinful_angelica: 'Angélica do Pecado',
      sigret: 'Sigret',
      silk: 'Seda',
      silver_blade_aramintha: 'Araminta da Lâmina Prateada',
      sol: 'Sol',
      solitaria_of_the_snow: 'Solitária das Neves',
      sonia: 'Sônia',
      specimen_sez: 'Espécime Sez',
      specter_tenebria: 'Tenébria Espectral',
      spirit_eye_celine: 'Celine Médium Espiritual',
      straze: 'Straze',
      summer_break_charlotte: 'Charlotte Férias de Verão',
      summer_disciple_alexa: 'Alexa Discípula do Verão',
      summertime_iseria: 'Iséria Tropical',
      surin: 'Surin',
      sven: 'Sven',
      sylvan_sage_vivian: 'Vivian Sábia da Floresta',
      taeyou: 'Taeyu',
      tamarinne: 'Tamarina',
      talaz: 'Talaz',
      talia: 'Talia',
      taranor_guard: 'Guarda de Taranor',
      taranor_royal_guard: 'Guarda Real de Taranor',
      tempest_surin: 'Tempestade Surin',
      tenebria: 'Tenébria',
      tieria: 'Tiéria',
      top_model_luluca: 'Luluca Supermodelo',
      troublemaker_crozet: 'Crozet Fora-da-Lei',
      twisted_eidolon_kayron: 'Espírito Distorcido Kayron',
      tywin: 'Tywin',
      ...
      vivian: 'Vivian',
      wanda: 'Wanda',
      wanderer_silk: 'Seda Errante',
      watcher_schuri: 'Observador Schuri',
      yoonryoung: 'Yun Ryeong',
      yufine: 'Yufina',
      yulha: 'Yul Ha',
      yuna: 'Yuna',
      zahhak: 'Zahhak',
      zealot_carmainerose: 'Carmainerosa Fanática',
      zeno: 'Zenão',
      zerato: 'Zerato',
      zio: 'Zio',
    },
    ...
    artifacts: {
      ...
      draco_plate: 'Placa Dracônica',
      dux_noctis: 'Dux Noctis',
      ...
      hostess_of_the_banquet: 'Hostess of the Banquet',
      ignition_cloth_gloves: 'Luva de Ignição',
      iron_fan: 'Leque de Ferro',
      jack_o_symbol: 'Símbolo da Jack-O',
      junkyard_dog: 'Junkyard Dog',
      kaladra: 'Kaladra',
      last_teatime: 'Última Hora do Chá',
      ...
      radiant_forever: 'Radiante Para Sempre',
      reingar_special_drink: 'Bebida Especial de Reingar',
      scroll_of_shadows: 'Pergaminho das Sombras',
      severed_horn_wand: 'Varinha de Chifre Cortado',
      shepherd_of_the_hollow: 'Pastor do Oblívio',
      sigurd_scythe: 'Foice de Sigurdo',
      spear_of_a_new_dawn: 'Lança da Gênese',
      spear_of_purification: 'Lança da Purgação',
      star_of_the_deep_sea: 'Estrela do Fundo do Mar',
      sword_of_cycling_seasons: 'Espada Cíclica',
      sword_of_summer_twilight: 'Espada da Noite de Verão',
      sword_of_the_morning: 'Espada da Manhã',
      sword_of_winter_shadow: 'Espada da Sombra Invernal',
    ...
    form: {
      ...
      share: 'Compartilhar',
      enemy_defeated: 'Herói derrotou um inimigo',
      single_attack_stack_3: 'Stack de Ataque Único',
      target_atk_down: 'Ataque Down do Alvo',
      target_atk_up_great: 'Ataque Greater do Alvo',
      target_atk_up: 'Aumento de Ataque do Alvo',
      target_attack: 'Ataque do Alvo',
      target_max_hp: 'Vida Máxima do Alvo',
      target_hp_pc: 'Vida Porcentagem do Alvo(%)',
      target_hp: 'Vida do Alvo',
      target_is_highest_max_hp: 'Vida Máxima do Alvo',
      target_speed: 'Speed do Alvo',
      target_nb_buff: 'Quantidade de Buffs do Alvo',
      target_nb_debuff: 'Quantidade de Debuffs do Alvo',
      target_has_buff: 'Alvo tem Buff',
      target_has_debuff: 'Alvo tem Debuff',
      target_has_bleed: 'Alvo Sangrando',
      target_has_sleep: 'Alvo Dormindo',
      target_is_stunned: 'Alvo Stunnado',
      target_has_barrier: 'Alvo com Barreira',
      target_magic_nailed: 'Alvo com Prego Mágico',
      target_nb_bleed: 'Quantidade de Sangramento do Alvo',
      target_bleed_detonate: 'Detona Sangramento do Alvo',
      target_burn_detonate: 'Detona Queima do Alvo',
      target_bomb_detonate: 'Detona Bomba do Alvo',
      torrent_set_stack: 'Staca Set de Torrent',
      caster_attacked_stack_3: 'Stack de Ataques do Herói',
      caster_attacked_stack_5: 'Stack de Ataques do Herói',
      caster_max_hp: 'Vida Máxima do Herói',
      caster_has_buff: 'Herói tem buff',
      caster_hp_pc: '% Vida do Herói',
      caster_hp: 'Vida do Herói',
      caster_hp_above_50pc: 'Vida abaixo de 50% do Herói',
      caster_defense: 'Defesa do Herói',
      caster_defense_up: 'Aumento de Defesa do Herói',
      caster_speed: 'Speed do Herói',
      caster_speed_up: 'Aumento de Speed do Herói',
      caster_nb_buff: 'Quantidade de Buffs do Herói',
      ...
      caster_nb_focus: 'Quantidade de Foco do Herói',
      caster_fighting_spirit: 'Espírito de Luta do Herói',
      ...
      critical_hit_stack_8: 'Stack de Acertos Críticos',
      critical_hit_stack_12: 'Stack de Acertos Críticos',
      attack_skill_stack_3: 'Stack de Skill de Ataque',
      attack_skill_stack_5: 'Stack de Skill de Ataque',
      attack_skill_stack_10: 'Stack de Skill de Ataque',
      non_attack_skill_stack_3: 'Stack de Skill de Ataque',
      non_attack_skill_stack_8: 'Stack de Skill de Ataque',
      non_attack_skill_stack_10: 'Stack de Skill de Ataque',
      s3_on_cooldown: 'S3 em Cooldown',
      target_current_hp: 'Vida atual do alvo',
      turn_stack: 'Turno para Stackar',
      turn_stack_3: 'Turnos para Stackar',
      turn_stack_10: 'Turnos para Stackar',
      dead_people: 'Alguém Morre',
      enemy_counters: 'Counter do Inimigo',
      highest_ally_attack: 'Aliado com Maior Ataque',
      ally_atk_up: 'Aumento Ataque de Aliado',
      ally_atk_up_great: 'Grande Aumento Ataque de Aliado',
      skill_tree_completed: 'Árvore de Skills Completa',
      s3_stack: 'Stack S3',
      all_allies_fire: 'Fogo em Todos os Aliados',
      exclusive_equipment_1: 'Equipamento Exclusivo #1',
      exclusive_equipment_2: 'Equipamento Exclusivo #2',
      exclusive_equipment_3: 'Equipamento Exclusivo #3',
    },
    skills: {
      ...
      s2: 'S2',
      s3: 'S3',
      s1_soulburn: 'Burn na S1',
      s2_soulburn: 'Burn na S2',
      ...
      mult: 'Multi',
      flat: 'Flat',
      critBoost: 'Dano Crítico',
      pen: 'Penetração',
      detonation: 'Detonação',
      exEq: 'Equipamento Exclusivo',
      elemAdv: 'Vantagem Elemental',
      fixed: 'Dano Fixo',
      custom: {
        all_fire: '{v}% Time de Fogo',
        ...
        caster_lost_hp_pc: '{v}% Vida% Perdida',
        caster_max_hp: '{v}% Vida Máxima',
        caster_hp_pc_over_hp_threshold: '{v}% Vida acima do Limite',
        caster_rage: '{v}% Raiva',
        caster_rage_flat: '{v}% Raiva',
        caster_speed: '{v}% Speed',
        caster_hp_pc_under_hp_threshold: '{v}% Vida abaixo do Limite',
        caster_vs_target_hp_diff: 'Diferença de HP Herói e Alvo: {v}%/1000hp',
        elemental_advantage: '{v}% Vantagem Elemental',
        per_crit_hit: '{v}% por Dano Crítico',
        per_target: '{v}% por Alvo',
        per_bleed: '{v}% por Sangramento',
        per_fewer_target: '{v}% por menos Alvos',
        per_focus: '{v}% por Foco',
        per_stack: '{v}% por Stack',
        per_target_debuff: '{v}% por Debuff no Alvo',
        skill_tree: 'Árvore de Skills: {v}%',
        target_bleed: 'Alvo Sangrando: {v}%',
        target_debuff: 'Debuff no Alvo: {v}%',
        target_has_barrier: 'Alvo com Barreira',
        target_has_buff: 'Alco com Buff: {v}%',
        target_has_debuff: 'Alvo com Debuff: {v}%',
        target_has_no_buff: 'Alvo Sem Debuff: {v}%',
        target_lost_hp_pc: '{v}% Alvo perdeu HP%',
        target_magic_nail: 'Prego Mágico: {v}%',
        target_max_hp: '{v}% Vida Máxima do Alvo',
        target_speed: '{v}% Speed do Alvo',
        under_threshold: '{v}% Abaixo do Limite',
      }
    },
    info: {
